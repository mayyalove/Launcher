...
class Launcher
{
     ...
     * @return void
     */
    public function LoadCircuitBreaker(array $circuitBreakerConfig)
    {
        $this->circuitBreaker = (isset($circuitBreakerConfig['open']) && $circuitBreakerConfig['open']) ? (new CircuitBreaker($circuitBreakerConfig)) : null;
    }
    ...
    public function configuration(array $properties)
    {
        ...
        $this->LoadCircuitBreaker($properties['circuitbreaker']);
    }
